...
function pohniHadem(dolu, doprava) {
  ...
  const cilovePolicko = document.getElementById(idCil);0
 ...
 if  (cilovePolicko.classList.contains("jablko")) {
  console.log("Had bude jíst"); 
  cilovePolicko.classlist.remove("jablko");
} else {
